...
def fetch_reply(msg, sessionId):
    ...
    if response.intent.display_name == 'Map':
        ...
        Stations = ["RedLine": "Shaheed Sthal (New Bus Adda), Hindon River, Arthala, Mohan Nagar, Shyam Park, Major Mohit Sharma, Rajender Nagar, Raj Bagh, Shahid Nagar, Dilshad Garden, Jhilmil, Mansarovar Park, Shahdara, Welcome, Seelampur, Shastri Park, Kashmere Gate, Tis Hazari, Pul Bangash, Pratap Nagar, Shastri Nagar, Inderlok, Kanhiya Nagar, Keshav Puram, Netaji Subhash Place, Kohat Enclave, Pitam Pura, Rohini East, Rohini West, Rithala",
        ...
        return stations[response.intent.display_name]
